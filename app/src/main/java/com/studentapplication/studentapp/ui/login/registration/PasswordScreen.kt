...
fun PasswordScreen(
    ...
    val buttonEnabled = (password.value.isNotEmpty() && rePassword.value.isNotEmpty()) && (password.value == rePassword.value)
        ...
        Column(
            ...
            Row(
                ...
                Box(
                    ...
                    Image(
                        painter = painterResource(R.drawable.deer),
            ...
            Text(
                text = "Your password needs to be at least 4 \n" +
                        "characters.",
